...
@slash_option(name="points",required=True, description="Total points", opt_type=OptionType.INTEGER)
@slash_option(name="earn_points",required=True, description="Points Added/Subtracted", opt_type=OptionType.INTEGER)
